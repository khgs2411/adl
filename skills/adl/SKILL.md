...
Architect start and refresh capture the focused Ghostty pane. If capture fails in Codex with a sandbox, `osascript`, Ghostty, or connection error, rerun the same CLI command with escalation/outside-sandbox access. If it still fails, run:
