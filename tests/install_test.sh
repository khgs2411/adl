...
assert_contains "$(cat "$default_home/.codex/skills/commission/SKILL.md")" "$default_home/.codex/skills/commission/scripts/commission" "codex installed commission skill should point to HOME default install path"
assert_contains "$(cat "$default_home/.claude/skills/commission/SKILL.md")" "$default_home/.claude/skills/commission/scripts/commission" "claude installed commission skill should point to HOME default install path"
...
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission-clear/SKILL.md"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission-clear/scripts/commission-clear"
...
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission/VERSION"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission/scripts/commission"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission/scripts/ghostty-macos"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission-clear/SKILL.md"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission-clear/scripts/commission-clear"
...
assert_contains "$(cat "$ADL_CODEX_SKILLS_DIR/commission/.commission-framework")" "COMMISSION_VERSION='$expected_version'" "update should reinstall current commission product version"
assert_contains "$(cat "$ADL_CLAUDE_SKILLS_DIR/commission/.commission-framework")" "COMMISSION_VERSION='$expected_version'" "default update should reinstall current commission version for claude"
