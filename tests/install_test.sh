...
export ADL_INSTALL_TRANSPORT=ghostty-macos
...
assert_file_exists "$default_home/.codex/skills/adl/.adl-config"
assert_file_exists "$default_home/.claude/skills/adl/.adl-framework"
assert_file_exists "$default_home/.claude/skills/adl/.adl-config"
assert_contains "$(cat "$default_home/.codex/skills/adl/.adl-config")" "ADL_TRANSPORT='ghostty-macos'" "codex default install should persist configured transport"
assert_contains "$(cat "$default_home/.claude/skills/adl/.adl-config")" "ADL_TRANSPORT='ghostty-macos'" "claude default install should persist configured transport"
...
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl/.adl-config"
assert_contains "$(cat "$ADL_CODEX_SKILLS_DIR/adl/.adl-config")" "ADL_TRANSPORT='ghostty-macos'" "codex install should persist configured transport"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl/scripts/adl"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl/scripts/ghostty-macos"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl/scripts/tmux"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl/scripts/terminal-macos"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl-clear/SKILL.md"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/adl-clear/scripts/adl-clear"
...
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/adl/.adl-config"
assert_contains "$(cat "$ADL_CLAUDE_SKILLS_DIR/adl/.adl-config")" "ADL_TRANSPORT='ghostty-macos'" "claude install should persist configured transport"
...
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/adl/scripts/tmux"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/adl/scripts/terminal-macos"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/adl-clear/SKILL.md"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/adl-clear/scripts/adl-clear"
...
transport_updated="$("$INSTALL_ROOT/.install.sh" --codex --update --transport tmux)"
expected_version="$(test_bumped_version patch "$expected_version")"
assert_contains "$transport_updated" "Configured ADL transport for codex: tmux" "explicit transport flag should report selected transport"
assert_contains "$(cat "$ADL_CODEX_SKILLS_DIR/adl/.adl-config")" "ADL_TRANSPORT='tmux'" "explicit transport flag should update installed config"
