...
assert_file_exists "$default_home/.codex/skills/commission/.commission-framework"
assert_file_exists "$default_home/.claude/skills/commission/.commission-framework"
...
mkdir -p "$ADL_CODEX_SKILLS_DIR/commission" "$ADL_CODEX_SKILLS_DIR/commission-connect" "$ADL_CODEX_SKILLS_DIR/commission-reset"
print -r -- "legacy commission skill" > "$ADL_CODEX_SKILLS_DIR/commission/SKILL.md"
print -r -- "legacy commission connect skill" > "$ADL_CODEX_SKILLS_DIR/commission-connect/SKILL.md"
print -r -- "legacy commission reset skill" > "$ADL_CODEX_SKILLS_DIR/commission-reset/SKILL.md"

output="$("$INSTALL_ROOT/.install.sh")"

assert_contains "$output" "Backed up existing adl skill" "installer should back up legacy skill"
assert_contains "$output" "Backed up existing commission skill" "installer should back up legacy commission skill"
assert_contains "$output" "Backed up existing commission-connect skill" "installer should back up legacy commission-connect skill"
assert_contains "$output" "Backed up existing commission-reset skill" "installer should back up legacy commission-reset skill"
...
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission/.commission-framework"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission/.commission-managed"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission/VERSION"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission/scripts/commission"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission/scripts/ghostty-macos"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission-connect/SKILL.md"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission-reset/SKILL.md"
assert_file_exists "$ADL_CODEX_SKILLS_DIR/commission-reset/scripts/commission-reset"
...
assert_contains "$(cat "$ADL_CODEX_SKILLS_DIR/commission/SKILL.md")" "$ADL_CODEX_SKILLS_DIR/commission/scripts/commission" "codex installed commission skill should point to overridden install path"
...
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission/.commission-framework"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission/scripts/commission"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission-reset/scripts/commission-reset"
assert_file_exists "$ADL_CLAUDE_SKILLS_DIR/commission-connect/SKILL.md"
...
assert_contains "$(cat "$ADL_CLAUDE_SKILLS_DIR/commission/SKILL.md")" "$ADL_CLAUDE_SKILLS_DIR/commission/scripts/commission" "claude installed commission skill should point to overridden install path"

backup_count="$(find "$ADL_CODEX_SKILLS_DIR/.adl-project-backups" -name SKILL.md | wc -l | tr -d ' ')"
assert_eq "4" "$backup_count" "legacy skill backups should exist for adl and commission collisions"
...
assert_eq "4" "$backup_count_after" "idempotent reinstall should not create another backup"
