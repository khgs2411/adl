...
assert_contains "$connect" "Pending Commissioner's Request: .commission/sessions/$session_id/runs/001/consumer-prompt.md" "connect should surface Commissioner-local request"
...
write_report "$COMMISSIONER/.commission/sessions/$session_id/runs/001/consumer-report.md"
