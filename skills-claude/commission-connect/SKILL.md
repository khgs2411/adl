...
description: Invoke as commission-connect for the Consumer side of the Commissioner-Consumer protocol in Claude Code. Use with a pin to connect from any directory while working against the printed target repo.
---
